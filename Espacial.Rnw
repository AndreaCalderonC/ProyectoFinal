...
\title{CARACTERIZACIÃ“N DE LOS INDICES DE DESARROLLO HUMANO EN COLOMBIA}
% autores
\renewcommand\Authand{, y }
\author[1]{\normalsize Andrea Calderon Corredor}


\affil[1]{\small  Facultad de IngenierÃ­a,Universidad de los Andes\\
...
@
\caption{Distribución de Indicadores de Poblaciones Normalizado}
\label{hist}
\end{figure}
...
#visualmente:  
plot(colb[,explanans],main="Correlación Población Cabecera Vs Población Restante", xlab=" Población de Cabecera", col="blue",ylab= "Poblacion Restante")
